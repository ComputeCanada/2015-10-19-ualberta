#Here we take the input from the file and turn it into an object we can easily work with, a list.  We also comment out the testing from before and do some new testing.
